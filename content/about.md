...
I was born in [Bailesti](https://en.wikipedia.org/wiki/B%C4%83ile%C8%99ti), [Southern Romania](https://en.wikipedia.org/wiki/Oltenia), in 1987, just two years before the fall of communism. That makes me an [Oltenian](https://en.wikipedia.org/wiki/Oltenia).
...
My first micro-computer was [one of these](https://muzeuldecalculatoare.ro/2018/09/23/i-c-e-felix-hc-91/). Most lucky Romanian kids from the 90s had one:
...
Later, I headed to [Bucharest](https://en.wikipedia.org/wiki/Bucharest) for the [Polytechnic University of Bucharest](https://en.wikipedia.org/wiki/Politehnica_University_of_Bucharest) (ETTI). I hold a bachelor's degree in *Electronics, Telecommunications, and Information Technology*, which makes me an *Electrical Engineer*.

{{< img src="/about/politehnica.jpeg" width="450" caption="Universitatea Politehnica, Bucharest, Romania" grayscale="true">}}
    
I consider myself a generalist, not a specialist. I know my way around low-level programming and quite a lot about building modern back-end systems. I've used countless libraries and frameworks, often reinventing the wheel just for the fun of it. I also still have some solid math skills up my sleeve, the kind of math an Electrical Engineer is expected to know. 

{{< img src="/about/qtest1.jpg" width="450" caption="View from the office" grayscale="true">}}
    
Romanian is my native language, and I’m fluent in English and French. I *almost speak* a fourth language, though I’ll keep that a secret for now.

Besides programming and math, I used to be ~~deeply~~ passionate about chess. At some point during high school, I stopped taking it quite so seriously, but the love for the game stuck. If you're up for a challenge, I’m around 1700 ELO on chess.com, maybe we can play someday!
