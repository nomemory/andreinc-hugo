...
<div class="mp" id="p00009">
        ...
        <p>Let \(a_1, a_2, a_3, a_4\) be positive real numbers. Prove the inequality:</p>
        <p class="mpc">
            \[
        ...
        <details>
            ...
            <p class="mpc">
                \[
                    4(a_1+a_2)(a_3+a_4) \leq (a_1+a_2+a_3+a_4)^2 \\
        ...
        <details>
            ...
            <p>Equality holds if and only if \(a_1=a_3\) and \(a_2=a_4\).</p>
        </details>
        <details>
