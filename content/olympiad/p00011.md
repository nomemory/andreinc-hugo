...
<div class="mp" id="p00011">
        ...
        <details>
           ...
           <p>Notice that the second inequality can be rewritten as:</p>
            <p class="mpc">
                \[
                    \sqrt{x-\frac{1}{3}}+\sqrt{y-\frac{1}{3}}+\sqrt{z-\frac{1}{3}} \geq 3
                \]
            </p>
        </details>
        <details>
            ...
            <p>Now, we can apply the AM-GM inequality (Arithmetic Mean-Geometric Mean Inequality) in a "forced" way. For every nonnegative number \(a\), \(\sqrt{a} \leq \frac{a+1}{2}\). Applying this to each term separately, we get:</p>
            <p class="mpc">
                \[
