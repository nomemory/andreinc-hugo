...
<div class="mp" id="p00028">
        ...
        <details>
            ...
            <p>Because \(x,y,z>0\), \(x+y+z=3\), and \(\lambda\ge3\), all three denominators \(\lambda-x\), \(\lambda-y\), and \(\lambda-z\) are positive. Moreover, \(3\lambda-(x^2+y^2+z^2)=\sum x(\lambda-x)>0\). Using \(x^2+y^2+z^2\ge3\), our previous inequality becomes:</p>
            <p class="mpc">
                \[
                    \frac{x}{\lambda - x}+\frac{y}{\lambda - y} + \frac{z}{\lambda - z} \ge \frac{9}{3\lambda - (x^2+y^2+z^2)} \\
                    \ge \frac{9}{3\lambda-3} = \frac{3}{\lambda-1}
                \]
            </p>
