...
<div class="mp" id="p00037">
        ...
        <p>Let \(n>1\) be an integer. Prove the inequality:</p>
        <p class="mpc">
            \[
        ...
        <details>   
            ...
            <p class="mpc">
                ...
                \]
                \[
                    \Leftrightarrow 2n\cdot\frac{n(n+1)}{2}+2n \gt 4\left(\sqrt{n}+\sqrt{2n}+\dots+\sqrt{n^2}\right)
                \]
            </p>
            ...
            <p>Summing these inequalities for \(k\) from 1 to \(n\) yields exactly the required inequality. Equality cannot hold simultaneously: already the first inequality would require \(n=1\), which is excluded.</p>
        </details>
        <details>
