...
<div class="mp" id="p00061">
    ...
    <details>
        ...
        <p class="mpc">
            ...
            \]
            \[
                = \frac{1}{x+y} + \frac{1}{y+z} + \frac{1}{z+x} \tag{3}
            \]
        </p>
    ...
    <details>
        ...
        <p class="mpc">
         ...
         <p>This final inequality is always true since squares are non-negative. Applying the same reasoning to all three terms and summing gives:</p>
         <p class="mpc">
            \[
                \sum_{\mathrm{cyc}}\frac{x}{\sqrt{(x^2+y^2)(x^2+z^2)}}
                \leq \frac{1}{y+z}+\frac{1}{z+x}+\frac{1}{x+y}.
            \]
         </p>
         <p>Finally, applying \(\frac{1}{u+v}\leq\frac14\left(\frac1u+\frac1v\right)\) to the three terms on the right gives:</p>
         <p class="mpc">
            \[
                \frac{1}{y+z}+\frac{1}{z+x}+\frac{1}{x+y}
                \leq \frac12\left(\frac1x+\frac1y+\frac1z\right),
            \]
         </p>
         <p>which completes the second proof. Equality holds if and only if \(x=y=z\).</p>
    </details>
    <details>
