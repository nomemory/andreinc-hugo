...
<div class="mp" id="p00085">
        ...
        <p>Let \(a_1, a_2, \dots, a_{2009}\) be positive real numbers such that \(\sum_{i=1}^{2009}a_i = 2009\). Prove the inequality:</p>
        <p class="mpc">
            \[
        ...
        <details>
            ...
            <p class="mpc">
                \[
                    ...
                    \frac{a_1+a_2}{2}+\dots+\frac{a_{2009}+a_1}{2}.
                \]
            </p>
            ...
            <p>Therefore, the inequality is proven. Equality holds if and only if \(a_1=a_2=\dots=a_{2009}=1\).</p>
        </details>
        <details>
