...
<div class="mp" id="p00102">
        ...
        <summary>Solution</summary>
            <p>In problems involving logarithmic inequalities, it is often useful to express all logarithms using a common base. Let \(k\gt1\). Using the base change formula:</p>
            <p class="mpc">
                \[
            ...
            <p class="mpc">
                \[
                    \frac{\log_k b + \log_k c}{\log_k a}+\frac{\log_k c + \log_k a}{\log_k b} + \frac{\log_k a + \log_k b}{\log_k c} \ge \\ \frac{4\log_k c}{\log_k a + \log_k b} + \frac{4\log_k a}{\log_k b + \log_k c}+\frac{4\log_k b}{\log_k a + \log_k c}
                \]
            </p>
            ...
            <p>The numbers \(x,y,z\) are all positive or all negative, so every ratio used below is positive. We reformulate the inequality as:</p>
            <p class="mpc">
                \[
            ...
            <p>Equality holds if and only if \(x=y=z\), which is equivalent to \(a=b=c\).</p>
        </details>
        <details>
