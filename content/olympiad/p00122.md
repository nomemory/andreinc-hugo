...
<details>
    ...
    <p>Because \(x,y,z>0\), we have \(a,b,c>1\), so each AM-GM inequality is strict. Therefore the sum is actually strictly less than \(3\). Equality would occur only at the excluded boundary point \(x=y=z=0\).</p>
</details>
<details>
