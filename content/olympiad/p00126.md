...
<div class="mp" id="p00126">
        ...
        <details>
            ...
            <p>Now, we apply the Cauchy-Schwarz argument used in the preceding refinement:</p>
            <p class="mpc">
            \[
                S_1 = \sum \frac{a^2}{a(xb+yc)}
                \ge \frac{(a+b+c)^2}{(x+y)(ab+bc+ca)}
                \ge \frac{3}{\underbrace{x+y}_{6}} = \frac{1}{2}.
            \]
            </p>
            ...
            <p class="mpc">
                \[
                    ...
                    S_2 \ge \frac{9}{(x+y)(a+b+c)} = \frac{1}{2}.
                \]
            </p>
