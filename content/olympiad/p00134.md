...
<details>
    ...
    <p>The fact that \(x^2-xy+y^2 \ge xy\) is a direct consequence of the AM-GM inequality:</p>
    <p class="mpc">
        \[
            x^2+y^2 \overbrace{\ge}^{AM-GM} 2xy \Leftrightarrow x^2 - xy + y^2 \ge xy
        \]
    </p>
    <p>We divide both sides by \(xy\):</p>
    <p class="mpc">
        \[
