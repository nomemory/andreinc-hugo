...
<div class="mp" id="p00145">
        ...
        <details>
            ...
            <p class="mpc">
                \[
                    ...
                    = \frac{2}{3}[\frac{1}{c(a+b)} + \frac{1}{a(b+c)} + \frac{1}{b(c+a)}] = \\
                     \frac{2}{3}\left(\frac{1}{ca+cb}+\frac{1}{ab+ac}+\frac{1}{bc+ba}\right)
                    \overbrace{\ge}^{\text{Titu's}} \frac{2}{3}\cdot\frac{(1+1+1)^2}{2(ab+bc+ca)}
                \]
            </p>
            ...
            <p>Equality holds exactly when \(a=b=c=\sqrt[3]{\frac{1}{3}}\).</p>
        </details>
    </div>
