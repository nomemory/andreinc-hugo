...
<div class="mp" id="p00147">
        ...
        <details>
            ...
            <p>We've formed three groups, \(S_1, S_2\), and \(S_3\). We need to find a lower bound for each of them.</p>
            <p>Given \(a+b+c=1\), by applying the AM-GM inequality: </p>
            <p class="mpc">
                \[
                    \frac{a+b+c}{3}\ge\sqrt[3]{abc} \Leftrightarrow \frac{1}{3} \ge \sqrt[3]{abc} \Rightarrow \frac{1}{abc}\ge 3^3=27
                \]
            </p>
            ...
            <p>Equality holds exactly when \(a=b=c=\frac{1}{3}\).</p>
