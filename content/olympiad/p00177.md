...
<div class="mp" id="p00177">
    ...
    <p>Find all nonnegative integers \(n \in \mathbb{N}_0\) that satisfy the following property: there exist integers \((a, b) \in \mathbb{Z}^2\) such that \(n^2 = a + b\) and \(n^3 = a^2 + b^2\).</p>
    <details>
